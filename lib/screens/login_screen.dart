    ...
    return CupertinoButton(child: Container(
      ...
      child: Row(
        ...
        children: [
          ...
          SizedBox(width: 10,),
          Text("Sign in with Phone",style: GoogleFonts.lato(
            color: Colors.white,
            fontSize: 20,
    ...
    return CupertinoButton(child: Container(
      ...
      child: Row(
        ...
        children: [
          ...
          SizedBox(width: 10,),
          Text("Sign in with Google",style:  GoogleFonts.lato(
              color: Colors.white,
              fontSize: 20,
              fontWeight: FontWeight.w400
          ),)
    ...
    return CupertinoButton(child: Container(
      ...
      child: Row(
        ...
        children: [
          ...
          SizedBox(width: 10,),
          Text("Sign in with Facebook",style:  GoogleFonts.lato(
              color: Colors.white,
              fontSize: 20,
              fontWeight: FontWeight.w400
          ),)
...
class TopLoginPathsPainter extends CustomPainter{
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final path =  Path()
      ...
      ..quadraticBezierTo(
        size.width * .7, size.height * .08, size.width * .9, size.height * .05,
      )
      ..arcToPoint(
        Offset(
          size.width * .93, size.height * .15,
        ),
        radius: Radius.circular(size.height * .05),
        largeArc: true,
      )
      ..cubicTo(
        size.width * .6, size.height * .15, size.width * .5, size.height * .46,
        0,
        size.height * .3,
      )
      ..lineTo(0, 0);
    ...
    path.quadraticBezierTo(
      size.width, size.height*0.85, size.width * .5,
      size.height,
    );
    path.close();
