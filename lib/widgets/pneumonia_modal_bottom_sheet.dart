...
class PneumoniaModalBottomSheet extends StatefulWidget {
  const PneumoniaModalBottomSheet({Key? key}) : super(key: key);

  @override
  State<PneumoniaModalBottomSheet> createState() => _PneumoniaModalBottomSheetState();
}

class _PneumoniaModalBottomSheetState extends State<PneumoniaModalBottomSheet> {
          ...
          child: ListView(
            children: [
                ...
                child: !isImagePicked? Center(
                  child: GestureDetector(
                    ...
                    child: Container(
                      ...
                      child: Text("Upload X-Ray Image",style: GoogleFonts.lato(
                          fontSize: 22,
              ...
              isImagePicked? Center(
                child: TextButton(onPressed: handlePneumoniaModel, child: Text("Get Results",style: GoogleFonts.lato(
                    fontSize: 20,
                    color: themeController.isDarkModeEnabled.value?Colors.grey[100]:Colors.grey[900],
  ...
  void handlePneumoniaModel() async{

    String? result = await HomeMedicaApi().getPneumoniaDiseaseResults(pickedImage!);
