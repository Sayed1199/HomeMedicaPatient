...
class Covid19ModalBottomSheet extends StatefulWidget {
  const Covid19ModalBottomSheet({Key? key}) : super(key: key);

  @override
  State<Covid19ModalBottomSheet> createState() => _Covid19ModalBottomSheetState();
}

class _Covid19ModalBottomSheetState extends State<Covid19ModalBottomSheet> {
          ...
          child: ListView(
            children: [
              ...
              isImagePicked? Center(
                child: TextButton(onPressed: handleCovid19Model, child: Text("Get Results",style: GoogleFonts.lato(
                    fontSize: 20,
                    color: themeController.isDarkModeEnabled.value?Colors.grey[100]:Colors.grey[900],
  ...
  void handleCovid19Model() async{

    String? result = await HomeMedicaApi().getCovid19DiseaseResults(pickedImage!);
